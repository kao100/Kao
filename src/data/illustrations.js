...
const SCENES = {
  ...
  sidePlank: {
    machine: () => `
      ${floor()}
      ${rect(60, 196, 200, 10, C.pad, 5)}`,
    athlete: () => `
      ${head(96, 126)}
      ${poly([[104, 138], [104, 196]])}
      ${poly([[104, 138], [206, 186]])}
      ${poly([[206, 186], [244, 196]])}
      ${poly([[104, 138], [104, 100]])}
      ${arrow(150, 196, 150, 168)}`,
  },

  hangingLegRaise: {
    machine: () => `
      ${rect(40, 36, 240, 12, C.frame, 6)}
      ${line(60, 48, 60, 210, C.frameLine, 6)}
      ${line(260, 48, 260, 210, C.frameLine, 6)}
      ${floor()}`,
    athlete: () => `
      ${head(160, 74)}
      ${poly([[160, 86], [160, 150]])}
      ${poly([[160, 92], [124, 52]])}
      ${poly([[160, 92], [196, 52]])}
      ${poly([[160, 150], [232, 142]])}
      ${arrow(206, 196, 220, 150)}`,
  },

  pallofPress: {
    machine: () => `
      ${rect(246, 60, 44, 150, C.stack, 6)}
      ${line(246, 110, 170, 120, C.cable, 4)}
      ${floor()}`,
    athlete: () => `
      ${head(120, 96)}
      ${poly([[120, 108], [120, 172]])}
      ${poly([[120, 172], [98, 210]])}
      ${poly([[120, 172], [146, 210]])}
      ${poly([[120, 120], [176, 120]])}
      ${arrow(150, 96, 196, 96)}`,
  },
  ...
  reverseCrunch: {
    machine: () => `
      ${floor()}
      ${rect(60, 190, 200, 12, C.pad, 5)}`,
    athlete: () => `
      ${head(80, 172)}
      ${poly([[92, 178], [166, 186]])}
      ${poly([[166, 186], [190, 140]])}
      ${poly([[190, 140], [222, 168]])}
      ${arrow(206, 180, 196, 132)}`,
  },

  abRollout: {
    machine: () => `
      ${floor()}
      ${circle(236, 186, 22, C.frame)}
      ${line(214, 186, 258, 186, C.frameLine, 5)}`,
    athlete: () => `
      ${head(96, 140)}
      ${poly([[106, 148], [106, 196]])}
      ${poly([[106, 148], [216, 176]])}
      ${arrow(150, 128, 216, 150)}`,
  },

  hollowHold: {
    machine: () => `
      ${floor()}
      ${rect(50, 192, 220, 12, C.pad, 5)}`,
    athlete: () => `
      ${head(96, 150)}
      ${poly([[106, 158], [160, 180]])}
      ${poly([[160, 180], [232, 148]])}
      ${poly([[106, 158], [74, 122]])}
      ${arrow(160, 200, 160, 176)}`,
  },
  ...
  lyingLegRaise: {
    machine: () => `
      ${floor()}
      ${rect(50, 196, 220, 10, C.pad, 5)}`,
    athlete: () => `
      ${head(74, 176)}
      ${poly([[86, 182], [168, 188]])}
      ${poly([[168, 188], [236, 150]])}
      ${arrow(214, 196, 226, 146)}`,
  },
  ...
  bicycleCrunch: {
    ...
    athlete: () => `
      ${head(84, 168)}
      ${poly([[96, 176], [166, 186]])}
      ${poly([[166, 186], [140, 146]])}
      ${poly([[140, 146], [172, 132]])}
      ${poly([[166, 186], [232, 178]])}
      ${arrow(120, 150, 152, 160)}`,
  },
  ...
  /* ================= ALTERNATIVAS DE PERNA (menos exigentes de equipamento) ========= */

  /* ---------- Agachamento em caixa / até a cadeira ---------- */
  boxSquat: {
    machine: () => `
      ${floor()}
      ${rect(186, 150, 96, 15, C.pad, 6)}
      ${rect(192, 165, 12, 47, C.frame)}
      ${rect(264, 165, 12, 47, C.frame)}`,
    athlete: () => `
      ${head(158, 92)}
      ${poly([[166, 104], [198, 144]])}
      ${poly([[170, 112], [128, 120]])}
      ${poly([[198, 144], [150, 158], [146, 202]])}
      ${arrow(104, 176, 104, 132)}`,
  },
  ...
  stepUp: {
    machine: () => `
      ${floor()}
      ${rect(170, 156, 104, 16, C.pad, 6)}
      ${rect(176, 172, 14, 40, C.frame)}
      ${rect(254, 172, 14, 40, C.frame)}`,
    athlete: () => `
      ${head(140, 84)}
      ${poly([[140, 96], [146, 142]])}
      ${poly([[142, 104], [116, 116]])}
      ${poly([[142, 104], [168, 100]])}
      ${poly([[146, 142], [178, 150], [186, 154]])}
      ${poly([[146, 142], [132, 178], [130, 208]])}
      ${arrow(100, 160, 100, 118)}`,
  },

  /* ---------- Afundo / avanço apoiado ---------- */
  splitSquat: {
    machine: () => `
      ${floor()}
      ${rect(206, 160, 76, 14, C.pad, 6)}
      ${rect(212, 174, 12, 38, C.frame)}
      ${rect(266, 174, 12, 38, C.frame)}`,
    athlete: () => `
      ${head(132, 86)}
      ${poly([[134, 98], [142, 142]])}
      ${poly([[136, 106], [112, 118]])}
      ${poly([[142, 142], [110, 168], [108, 208]])}
      ${poly([[142, 142], [180, 168], [208, 158]])}
      ${arrow(80, 128, 80, 168)}`,
  },
  ...
  gluteBridge: {
    machine: () => `
      ${floor()}
      ${rect(66, 196, 190, 12, C.pad, 6)}`,
    athlete: () => `
      ${head(88, 176)}
      ${poly([[100, 172], [156, 146]])}
      ${poly([[156, 146], [196, 172], [198, 196]])}
      ${poly([[104, 178], [128, 190]])}
      ${arrow(156, 118, 156, 138)}`,
  },

  /* ---------- Stiff unilateral (peso corporal) ---------- */
  singleLegRdl: {
    machine: () => `
      ${floor()}
      ${line(40, 208, 280, 208, C.floor, 5)}`,
    athlete: () => `
      ${head(104, 110)}
      ${poly([[116, 114], [176, 130]])}
      ${poly([[128, 120], [126, 158]])}
      ${poly([[176, 130], [186, 168], [184, 206]])}
      ${poly([[176, 130], [216, 118], [244, 118]])}
      ${arrow(80, 148, 80, 108)}`,
  },

  /* ---------- Extensão de tronco no solo (superman) ---------- */
  superman: {
    machine: () => `
      ${floor()}
      ${rect(56, 190, 210, 12, C.pad, 6)}`,
    athlete: () => `
      ${head(92, 150)}
      ${poly([[104, 154], [180, 168]])}
      ${poly([[100, 152], [72, 136]])}
      ${poly([[180, 168], [216, 150]])}
      ${arrow(150, 124, 150, 146)}`,
  },
  ...
  pullUp: {
    machine: () => `
      ${floor()}
      ${rect(72, 26, 176, 11, C.frame, 4)}
      ${line(108, 37, 108, 62, C.frame, 7)}
      ${line(212, 37, 212, 62, C.frame, 7)}
      ${line(84, 62, 236, 62, C.frameLine, 9)}`,
    athlete: () => `
      ${head(160, 96)}
      ${poly([[138, 64], [130, 88], [152, 106]])}
      ${poly([[182, 64], [190, 88], [168, 106]])}
      ${poly([[160, 108], [162, 148]])}
      ${poly([[162, 148], [150, 176], [164, 190]])}
      ${poly([[162, 148], [174, 176], [188, 188]])}
      ${arrow(258, 152, 258, 106)}`,
  },
  ...
  deadHang: {
    ...
    athlete: () => `
      ...
      ${poly([[142, 64], [152, 118]])}
      ${poly([[178, 64], [168, 118]])}
      ${poly([[160, 118], [160, 156]])}
      ${poly([[160, 156], [154, 190]])}
      ${poly([[160, 156], [168, 190]])}`,
  },
  ...
  hangingKneeRaise: {
    machine: () => `
      ${floor()}
      ${rect(60, 26, 176, 11, C.frame, 4)}
      ${line(96, 37, 96, 62, C.frame, 7)}
      ${line(200, 37, 200, 62, C.frame, 7)}
      ${line(72, 62, 224, 62, C.frameLine, 9)}`,
    athlete: () => `
      ${poly([[146, 64], [150, 114]])}
      ${head(163, 110)}
      ${poly([[151, 120], [152, 172]])}
      ${poly([[152, 172], [200, 138], [208, 174]])}
      ${arrow(238, 200, 238, 152)}`,
  },
  ...
  pushUp: {
    machine: () => `
      ${floor()}
      ${line(46, 202, 280, 202, C.floor, 6)}`,
    athlete: () => `
      ${head(88, 146)}
      ${poly([[100, 152], [200, 172]])}
      ${poly([[104, 154], [102, 196]])}
      ${poly([[200, 172], [240, 196]])}
      ${arrow(150, 116, 150, 148)}`,
  },

  /* ---------- Flexão inclinada (mãos apoiadas) ---------- */
  inclinePushUp: {
    machine: () => `
      ${floor()}
      ${rect(66, 128, 88, 14, C.pad, 6)}
      ${rect(72, 142, 12, 44, C.frame)}
      ${rect(136, 142, 12, 44, C.frame)}`,
    athlete: () => `
      ${head(104, 108)}
      ${poly([[116, 116], [214, 176]])}
      ${poly([[112, 118], [108, 130]])}
      ${poly([[214, 176], [248, 198]])}
      ${arrow(168, 106, 148, 128)}`,
  },
  ...
  pikePushUp: {
    ...
    athlete: () => `
      ${head(112, 158)}
      ${poly([[122, 152], [166, 108]])}
      ${poly([[118, 162], [108, 194]])}
      ${poly([[166, 108], [206, 152], [216, 196]])}
      ${arrow(84, 122, 84, 158)}`,
  },

  /* ---------- Remada invertida (sob a mesa / barra baixa) ---------- */
  invertedRow: {
    machine: () => `
      ${floor()}
      ${rect(72, 118, 190, 14, C.pad, 6)}
      ${rect(78, 132, 12, 76, C.frame)}
      ${rect(244, 132, 12, 76, C.frame)}`,
    athlete: () => `
      ${head(112, 168)}
      ${poly([[124, 166], [222, 184]])}
      ${poly([[132, 162], [136, 134]])}
      ${poly([[146, 164], [150, 134]])}
      ${poly([[222, 184], [252, 202]])}
      ${arrow(190, 218, 190, 188)}`,
  },
  ...
  backpackRow: {
    machine: () => `
      ${floor()}
      ${rect(126, 168, 44, 40, C.pad, 8)}
      ${rect(140, 158, 16, 12, C.frameLine, 4)}`,
    athlete: () => `
      ${head(104, 108)}
      ${poly([[116, 114], [186, 132]])}
      ${poly([[140, 122], [146, 150]])}
      ${poly([[186, 132], [190, 172], [188, 206]])}
      ${arrow(96, 168, 96, 132)}`,
  },
  ...
  benchDip: {
    machine: () => `
      ${floor()}
      ${rect(62, 132, 92, 14, C.pad, 6)}
      ${rect(68, 146, 12, 62, C.frame)}
      ${rect(136, 146, 12, 62, C.frame)}`,
    athlete: () => `
      ${head(126, 108)}
      ${poly([[128, 120], [136, 164]])}
      ${poly([[124, 124], [110, 138]])}
      ${poly([[136, 164], [196, 172], [232, 196]])}
      ${arrow(178, 118, 178, 150)}`,
  },
